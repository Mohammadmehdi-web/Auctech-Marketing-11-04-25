...
<body>
    ...
    <div class="service-details-page  body-black ">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="service-details-wcu-wrapper">
                            ...
                            <div class="service-details-wcu-title"
                                ...
                                <h3>Smarter Bidding for Smarter <span>Business Growth</span></h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="wcu-area-card-info-secondary">
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p class="mt-3">
                                    ...
                                    <strong class="text-white">Campaign Creation: </strong>Creating and launching successful ad campaigns.
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
        ...
        <div class="wcu-area body-black p-relative pb-140 ">
            <div class="container">
                <div class="section-title mb-20 style-1 mb-5">
                    ...
                    <div class="col-xl-12">
                        <div class="wcu-area-card-info">
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p>
                                Setting clear goals and objectives is the foundation of a successful ad campaign. Without well-defined targets, it becomes challenging to measure success or optimize performance. Establishing goals ensures your efforts remain focused and aligned with your business objectives.
                                </p>
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <div class="title-border-3 mt-30 mb-30"></div>
                                <p>
                                Selecting the right advertising platform is essential for the success of your campaign. Each platform has its strengths and caters to different types of audiences and marketing goals. By choosing the most suitable platform, you ensure your ads reach the right people at the right time.
                                </p>
                            </div>
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <div class="title-border-3 mt-30 mb-30"></div>
                               <p>Keyword research is a crucial step in designing effective ad campaigns. It helps you find the right words and phrases that your target audience is searching for, ensuring your ads appear to the right people. With proper keyword selection, you can maximize visibility, drive quality traffic, and improve your return on investment (ROI).
                               </p>
                            </div>
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <div class="title-border-3 mt-30 mb-30"></div>
                               <p>
                               Creating persuasive ad copy is essential for capturing your audience's attention and encouraging them to take action. A well-crafted ad copy directly speaks to the needs and desires of your target audience, increasing your click-through rate (CTR) and maximizing your return on investment (ROI).
                               </p>
                            </div>
            ...
            <div class="pricing-area body-black pb-140 ">
                <div class="container">
                    <div class="section-title mb-60 style-2">
                        ...
                        <h2>Mention tools and methods</h2>
                    </div>
                    <div class="row">
                            ...
                            <div class="pricing-area-card p-relative" id="cards-1">
                                <div class="pricing-area-card-wrapper">
                                    ...
                                    <div class="pricing-area-cards-list">
                                        <ul>
                                            <li class="checkmark">Create and manage search, display, and shopping ads.
                                            </li>
                                            <li class="checkmark">Track performance and adjust bids for better ROI.
                                            </li>
                                            <li class="checkmark">Use A/B testing to optimize campaigns.
                                            </li>
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="pricing-area-card p-relative" id="cards-2">
                                <div class="pricing-area-card-wrapper">
                                    ...
                                    <div class="pricing-area-cards-list">
                                        <ul>
                                            <li class="checkmark">Track user behavior and conversions.</li>
                                            <li class="checkmark">Evaluate campaign effectiveness.
                                            </li>
                        ...
                        <div class="col-xl-4 col-lg-4 ">
                            <div class="pricing-area-card p-relative" id="cards-3">
                                <div class="pricing-area-card-wrapper">
                                    ...
                                    <div class="pricing-area-card-text">
                                        <h5>A/B Testing Tools</h5>

                                    </div>
                                    <div class="pricing-area-cards-list">
                                        <ul>
                                            <li class="checkmark">Test ads with Google Optimize for best results.</li>
                                            <li class="checkmark"> Identify which ads generate better results.
