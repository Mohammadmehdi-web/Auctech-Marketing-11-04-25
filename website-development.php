...
<head>
    ...
    <title>Auctech Marketing Pvt. Ltd. | Website Development</title>
    ...
    <div class="service-details-page  body-black ">
        <div class="pages-heading p-relative">
            ...
            <div class="pages-heading-text style-2 p-absolute z-index-1">
                <span>Home / Website Development</span>
                        ...
                        <div class="wcu-area-card-info-secondary">
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p class="mt-3">
                                    ...
                                    seamless navigation and payment integration.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="wcu-area-card-info">
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p class="mb-2">
                                    ...
                                    suitable for content-heavy platforms like blogs, news portals, interactive
                                    service sites.
                                </p>
                        ...
                        <div class="">
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p class="mt-2 mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                     Easy-to-use menus and search bars.
                                </p>
                                <p class="mt-2">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                ...
                                <p class="mt-2">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    Effective buttons guiding user actions.
                                </p>
                                <p class="mt-2">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    Uniform colors, fonts, and layout.
                                </p>

                                <p class="mt-2">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                   Support for all users, including disabled individuals.
                                </p>
                            </div>
                        </div>
                    </div>
