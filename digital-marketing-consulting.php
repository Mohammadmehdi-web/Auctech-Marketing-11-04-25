...
<head>
    ...
    <title>Auctech Marketing Pvt. Ltd. | Digital Marketing Consulting</title>
    ...
    <div class="service-details-page  body-black ">
        <div class="pages-heading p-relative">
            ...
            <div class="pages-heading-text style-2 p-absolute z-index-1">
                <span>Home / Digital Marketing Consulting</span>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="service-details-wcu-wrapper">
                            ...
                            <div class="service-details-wcu-title"
                                ...
                                <h3>Turning Visitors into <span>Loyal Customers</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        ...
                        <div class="wcu-area-card-info-secondary">
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p>At Auctech, we provide customized digital marketing consulting services that help
                                    businesses grow by reaching the right audience and delivering measurable results.
                                    Every business is unique, and that’s why we create tailored marketing strategies
                                    aligned with your specific goals. At Auctech, we help businesses grow by creating
                                    customized digital marketing strategies that bring real results. Every business is
                                    different, so we design marketing plans that fit your specific needs.
                                </p>
                            ...
                            <div class="wcu-area-info-card-wrapper">
                                ...
                                <p class="mt-3">
                                    ...
                                    <strong class="text-white"> Strategy Development: </strong> Custom plans aligned
                                    with
                                    your objectives.
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong class="text-white"> Campaign Planning: </strong> Budgeting, channel selection, tracking.
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong class="text-white"> Content Marketing: </strong> Blogs, videos, and social media.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row ">
                    ...
                    <div class="col-xl-8">
                        <div class="section-title mb-60 style-1">
                            ...
                            <h2>How Tailored Marketing Strategies Drive Results</h2>
                        </div>
                        <div class="">
                            <div class="wcu-area-info-card-wrapper">
                                <p class="mb-2 text-justify">
                                    A tailored marketing strategy is a personalized plan designed to meet your
                                    business’s specific goals by reaching the right audience at the right time. Unlike a
                                    one-size-fits-all approach, it takes into account your industry, target market, and
                                    objectives to maximize impact. At Auctech, we specialize in creating customized
                                    strategies that deliver measurable results.
                                </p>
                                <p class="mt-4">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong> Increasing Brand Awareness.</strong> 
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong> Boosting Website Traffic.</strong> 
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                    <strong> Generating Leads & Sales.</strong> 
                                </p>
                                <p class="mt-3">
                                    <img width="20" height="20"
                                        src="https://img.icons8.com/glyph-neue/64/FAB005/instagram-verification-badge.png" />
                                ...
                                <div class="pricing-area-card-wrapper">
                                    ...
                                    <div class="pricing-area-cards-list">
                                        <ul>
                                            ...
                                            <li class="checkmark"> Allocate budgets efficiently.</li>
                                            <li class="checkmark">Monitor campaigns in real-time.</li>
                                            <li class="checkmark">Optimize for better results.</li>
                                ...
                                <div class="pricing-area-card-wrapper">
                                    ...
                                    <div class="pricing-area-cards-list">
                                        <ul>
                                            ...
                                            <li class="checkmark">Create visually appealing infographics and videos.
                                            </li>
                                            <li class="checkmark">Design social media posts and ad creatives.</li>
                                            <li class="checkmark">Craft persuasive ad copy that converts.</li>
                        ...
                        <div class="col-xl-4 col-lg-4 ">
                            <div class="pricing-area-card p-relative" id="cards-3">
                                <div class="pricing-area-card-wrapper">
                                    ...
                                    <div class="pricing-area-cards-list">
                                        <ul>
                                            <li class="checkmark">Track performance using analytics tools.</li>
                                            <li class="checkmark">Evaluate returns with clear formulas.</li>
                                            <li class="checkmark">Get insights for better decisions.</li>
