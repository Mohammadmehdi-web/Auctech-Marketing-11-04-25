...
<body>
    ...
    <div class="service-details-page  body-black ">
        ...
        <div class="our-work-step pb-140 pt-140">
            <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <img src="images/portfolio/1.png" alt="" width="70%">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <img src="images/portfolio/2.png" alt="" width="70%">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <img src="images/portfolio/3.png" alt="" width="70%">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <img src="images/portfolio/4.jpg" alt="" width="70%">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row wrap mt-5">
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <img src="images/portfolio/5.jpg" alt="" width="70%">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="our-work-step-card-wrapper">
                            <div class="our-work-step-card-title">
                                <img src="images/portfolio/6.jpg" alt="" width="70%">
                            </div>
                        </div>
                    </div>
                </div>
