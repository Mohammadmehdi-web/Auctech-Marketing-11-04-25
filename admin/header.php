        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <ul class="side-menu metismenu">
                    <li>
                        <a class="active mt-5" href="index"><i class="sidebar-item-icon"><img width="30" height="30" src="https://img.icons8.com/glyph-neue/50/FFFFFF/speed.png" alt="speed"/></i>
                    ...
                    <li>
                     ...
                     <li>
                        <a class="" href="job_list"><i class="sidebar-item-icon"><img width="30" height="30" src="https://img.icons8.com/ios-glyphs/30/FFFFFF/new-job.png" alt="new-job"/></i>
